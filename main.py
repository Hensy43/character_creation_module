...
def defence(char_name: str, char_class: str) -> str:
    ...
    блокированного урона, в зависимости от класса бойца.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Данная функция определяет колличество.
    нанесенного урона, в случае применения специального умения,
    в зависимости от класса бойца.
    """
    if char_class == 'warrior':
        return (
...
def start_training(char_name: str, char_class: str) -> str:
    """Данная функция играет роль треннажера.
    благодаря ей мы имеем возможность
    попробывать по управлять своими навыками.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Данная функция позволяет выбрать класс.
    бойца, за которого будет продолжаться игра.
    """
    approve_choice = None
    char_class = None
